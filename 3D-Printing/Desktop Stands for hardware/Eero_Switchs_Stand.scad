...
// 6mm walls, integrated pegs, device-specific recessed pockets
// ============================================
...
// ============================================
// LAYER 2: MIDDLE — UGREEN + Warrky (dual pocket)
// ============================================
module layer2() {
    gap = 15;
    ...
    difference() {
        ...
        // PEG HOLES — now properly inside difference()!
        for(pos = peg_positions) {

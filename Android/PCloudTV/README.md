...
<p align="center"><strong>v4.23</strong></p>
...
<p align="center">
  <a href="https://github.com/MikereDD/It-Works-On-My-Machine/releases/download/pCloudTV-v4.23/pCloudTV-v4.23.apk"><strong>Download the APK (v4.23)</strong></a>
</p>
...
1. Download **[pCloudTV-v4.23.apk](https://github.com/MikereDD/It-Works-On-My-Machine/releases/download/pCloudTV-v4.23/pCloudTV-v4.23.apk)** and copy it to your phone or Android TV device.
...
**Player (TV remote):** **Left / Right** move the highlight across the control buttons - **OK** press the highlighted button (play/pause, -/+10s, start, end) - **Up / Menu** audio & subtitle tracks - **Down** wake controls - **Back** exit.

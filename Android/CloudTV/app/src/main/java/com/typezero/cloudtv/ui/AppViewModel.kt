...
import com.typezero.cloudtv.data.Account
import com.typezero.cloudtv.data.CloudProvider
import com.typezero.cloudtv.data.PCloudProvider
import com.typezero.cloudtv.data.PCloudClient
import com.typezero.cloudtv.data.Publink
import com.typezero.cloudtv.data.SessionStore
...
class AppViewModel(app: Application) : AndroidViewModel(app) {
    ...
    /**
     * The cloud provider bound to the active account. The browse/stream layer
     * talks to this rather than a specific client. When Google Drive lands this
     * branches on the active account's provider type.
     */
    val activeProvider: CloudProvider?
        get() = session?.let { PCloudProvider(client, it) }
